...
// PID constants
#define Kp 36.5   // Proportional gain 36.5 SENSOR DIDEPAN
#define Ki 0.1   // Integral gain
#define Kd 6.0     // Derivative gain
...
void calculateError() {
  ...
  else if (bin_Sensor == 0b011111111111) error = -5.5;
  else if (bin_Sensor == 0b001111111111) error = -5;
  else if (bin_Sensor == 0b101111111111) error = -4.5;
  else if (bin_Sensor == 0b100111111111) error = -4;
  else if (bin_Sensor == 0b110111111111) error = -3.5;
  else if (bin_Sensor == 0b110011111111) error = -3;
  else if (bin_Sensor == 0b111011111111) error = -2.5;
  else if (bin_Sensor == 0b111001111111) error = -2;
  else if (bin_Sensor == 0b111101111111) error = -1.5;
  else if (bin_Sensor == 0b111100111111) error = -1;
  else if (bin_Sensor == 0b111110111111) error = -0.5;
  else if (bin_Sensor == 0b111110011111) error = 0;
  else if (bin_Sensor == 0b111111011111) error = 0.5;
  else if (bin_Sensor == 0b111111001111) error = 1;
  else if (bin_Sensor == 0b111111101111) error = 1.5;
  else if (bin_Sensor == 0b111111100111) error = 2;
  else if (bin_Sensor == 0b111111110111) error = 2.5;
  else if (bin_Sensor == 0b111111110011) error = 3;
  else if (bin_Sensor == 0b111111111011) error = 3.5;
  else if (bin_Sensor == 0b111111111001) error = 4;
  else if (bin_Sensor == 0b111111111101) error = 4.5;
  else if (bin_Sensor == 0b111111111100) error = 5;
  else if (bin_Sensor == 0b111111111110) error = 5.5;
